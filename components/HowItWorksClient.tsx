...
export function HowItWorksClient() {
  ...
  const steps = [
    ...
    },
    {
      ...
      description:
        'Our engine auto-calculates line items, 7.5% NGN VAT tax, applies currency conversions, and stamps a cryptographic QR verification code.',
      icon: FileText,
    ...
    },
    {
      ...
      description:
        'Customers pay via Paystack Inline JS modal supporting Master/Visa Cards, Bank Transfer, USSD (*737#), and Apple Pay.',
      icon: CreditCard,
    ...
    },
    {
      ...
      description:
        'Paystack dispatches event `charge.success`. Signature is validated, invoice status becomes PAID, and instant receipts are generated.',
      icon: CheckCircle2,
